  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900">LinkedIn</h1>
          <p className="text-slate-500 mt-1">Contenu organisé par thématique</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {CATEGORIES.map((cat) => {
          ...
          return (
            <Link key={cat.slug} href={`/content/linkedin/${encodeURIComponent(cat.slug)}`} className="group block">
